...
public class twPhePdf extends AppCompatActivity {
    ...
    public twPhePdf() {
        this.mhref = this.database.getReference("CbPheTw");
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mhref.addValueEventListener(new ValueEventListener() {
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                twPhePdf.this.text1.setText(value);
//                Toast.makeText(nineMathPdf.this, "Updated", Toast.LENGTH_SHORT).show();
                String url = twPhePdf.this.text1.getText().toString();
                (twPhePdf.this.new RetrivePdfStream()).execute(new String[]{url});
            }

            public void onCancelled( DatabaseError databaseError) {
                Toast.makeText(twPhePdf.this, "Failed to Update", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    class RetrivePdfStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPostExecute(InputStream inputStream) {
            twPhePdf.this.pdfView.fromStream(inputStream).load();
        }
    }
}
