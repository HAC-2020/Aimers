...
public class twChemPdf extends AppCompatActivity {
    ...
    public twChemPdf() {
        this.mhref = this.database.getReference("CbChemTw");
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mhref.addValueEventListener(new ValueEventListener() {
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                twChemPdf.this.text1.setText(value);
//                Toast.makeText(nineMathPdf.this, "Updated", Toast.LENGTH_SHORT).show();
                String url = twChemPdf.this.text1.getText().toString();
                (twChemPdf.this.new RetrivePdfStream()).execute(new String[]{url});
            }

            public void onCancelled( DatabaseError databaseError) {
                Toast.makeText(twChemPdf.this, "Failed to Update", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    class RetrivePdfStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPostExecute(InputStream inputStream) {
            twChemPdf.this.pdfView.fromStream(inputStream).load();
        }
    }
}
