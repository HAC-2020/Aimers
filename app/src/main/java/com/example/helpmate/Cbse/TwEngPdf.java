...
public class TwEngPdf extends AppCompatActivity {
    ...
    public TwEngPdf() {
        this.mhref = this.database.getReference("CbEngTw");
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mhref.addValueEventListener(new ValueEventListener() {
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                TwEngPdf.this.text1.setText(value);
//                Toast.makeText(nineMathPdf.this, "Updated", Toast.LENGTH_SHORT).show();
                String url = TwEngPdf.this.text1.getText().toString();
                (TwEngPdf.this.new RetrivePdfStream()).execute(new String[]{url});
            }

            public void onCancelled( DatabaseError databaseError) {
                Toast.makeText(TwEngPdf.this, "Failed to Update", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    class RetrivePdfStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPostExecute(InputStream inputStream) {
            TwEngPdf.this.pdfView.fromStream(inputStream).load();
        }
    }
}
