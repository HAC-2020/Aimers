...
public class twBioPdf extends AppCompatActivity {
    ...
    public twBioPdf() {
        this.mhref = this.database.getReference("CbBioTw");
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mhref.addValueEventListener(new ValueEventListener() {
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                twBioPdf.this.text1.setText(value);
//                Toast.makeText(nineMathPdf.this, "Updated", Toast.LENGTH_SHORT).show();
                String url = twBioPdf.this.text1.getText().toString();
                (twBioPdf.this.new RetrivePdfStream()).execute(new String[]{url});
            }

            public void onCancelled( DatabaseError databaseError) {
                Toast.makeText(twBioPdf.this, "Failed to Update", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    class RetrivePdfStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPostExecute(InputStream inputStream) {
            twBioPdf.this.pdfView.fromStream(inputStream).load();
        }
    }
}
