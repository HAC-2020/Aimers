...
public class nineMathPdf extends AppCompatActivity {
    ...
    public nineMathPdf() {
        this.mhref = this.database.getReference("CbmathsTen");
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mhref.addValueEventListener(new ValueEventListener() {
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                nineMathPdf.this.text1.setText(value);
//                Toast.makeText(nineMathPdf.this, "Updated", Toast.LENGTH_SHORT).show();
                String url = nineMathPdf.this.text1.getText().toString();
                (nineMathPdf.this.new RetrivePdfStream()).execute(new String[]{url});
            }

            public void onCancelled( DatabaseError databaseError) {
                Toast.makeText(nineMathPdf.this, "Failed to Update", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    class RetrivePdfStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPostExecute(InputStream inputStream) {
            nineMathPdf.this.pdfView.fromStream(inputStream).load();
        }
    }
}
